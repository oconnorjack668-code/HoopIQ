...
export const metadata = { title: 'Video - HoopIQ' };
    ...
    <div className="flex-1 overflow-auto p-4 md:p-8 max-w-7xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">Upload guided shooting clips, track pose landmarks, compare over time</p>
        </div>
      </div>
      ...
      <Card className="border-zinc-800 bg-zinc-900/50">
        <CardContent className="p-12 text-center">
          ...
          <p className="text-sm text-zinc-400">Private uploads, pose analysis, clip comparison</p>
        </CardContent>
      </Card>
    </div>
  );
